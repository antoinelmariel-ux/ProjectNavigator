          ...
          >
            ...
            {shouldShowNextButton && (
              <button
                ...
                data-tour-id={currentIndex === questions.length - 1 ? 'questionnaire-view-showcase' : undefined}
              >
                {currentIndex === questions.length - 1 ? t('questionnaire.viewShowcase') : t('questionnaire.next')}
